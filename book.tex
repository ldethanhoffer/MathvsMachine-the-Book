...
We will fix a probability space $(\textrm{U}, \r{U},\mu)$ and throughout any random variable will always have this as its domain
\end{convention}
...
\]
endowed with the canonical $\sigma$-algebra $\coprod \r{F}$.\\
